...
对于不是开发者的朋友，可以通过下载 [BiliBiliTool/release](https://github.com/CyL-Cly/BiliBiliToolPro/releases) 到本地或任意服务器运行。
...
```
wget https://github.com/CyL-Cly/BiliBiliToolPro/releases/download/0.3.1/bilibili-tool-pro-v0.3.1-linux-x64.zip
