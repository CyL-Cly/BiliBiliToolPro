...
[Overview of BiliBili Tool](https://github.com/CyL-Cly/BiliBiliToolPro)
...
```console
$ git clone https://github.com/CyL-Cly/BiliBiliToolPro.git
...
这个chart通过[Helm](https://helm.sh)在[Kubernetes](https://kubernetes.io)集群上拉起一个[BiliBiliToolPro](https://github.com/CyL-Cly/BiliBiliToolPro)deployment
...
| `env` | Environment variables for the BiliBili Tool container, Ray_BiliBiliCookies__1 and Ray_DailyTaskConfig__Cron are required, others vars pls take a look at [supported envvars](https://github.com/CyL-Cly/BiliBiliToolPro/blob/main/docs/configuration.md) | `[]` | true |
